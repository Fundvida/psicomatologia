...
<body id="page-top">
    ...
    <section class="py-1 d-flex justify-content-center align-items-center" id="pacientes">
        <div class="container px-5">
            <div class="container px-5 shadow-lg p-5 rounded mt-2">
            <!-- Título -->
            <h2 class="display-3 text-center lh-1 mb-5 font-alt">Listado de Pacientes</h2>
                        ...
                        <div class="modal-body">
                            <form>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-primary" onclick="mostrarErrorPaciente()">Cancelar</button>
                                    <!--<button type="button" class="btn btn-primary" onclick="registrarPaciente()">Registrar Paciente</button>-->
                                    <button type="button" class="btn btn-primary" onclick="validarFormulario()">Registrar Paciente</button>
            ...
            <div class="text-end mb-3">
                <button class="btn btn-outline-primary btn-lg btn-paso1 fw-bold" onclick="mostrarFormulario()" style="font-size: 20px; padding: 12px 14px;">
                    <i class="bi bi-person-plus-fill fs-4 me-2"></i> Agregar Paciente
                </button>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="action-icons">
                                <i class="fa-solid fa-calendar-check" style="color: #6C757D; font-size: 22px;" onclick="programarSesion()" title="Programar Sesión"></i>
                                <i class="fa-solid fa-user-lock text-danger" style="font-size: 22px;" onclick="confirmarBloqueoPaciente('Juan Pérez')" title="Bloquear Paciente"></i>
                                <i class="fa-solid fa-hospital-user" style="font-size: 22px; color: #1D5776" onclick="confirmarDarAlta('Juan Pérez')" title="Dar de Alta"></i>
                            </td>
                        </tr>
                        <tr>
                            <td>6434344</td>
                            ...
                            <td class="action-icons">
                                ...
                                <i class="fa-solid fa-calendar-check" style="color: #6C757D; font-size: 22px;" onclick="programarSesion()" title="Programar Sesión"></i>
                                <i class="fa-solid fa-user-lock text-danger" style="font-size: 22px;" onclick="confirmarBloqueoPaciente('Maria García')" title="Bloquear Paciente"></i>
                            </td>
                        </tr>
                        <tr>
                            <td>2727272</td>
                            ...
                            <td class="action-icons">
                                <i class="fa-solid fa-calendar-check" style="color: #6C757D; font-size: 22px;" onclick="programarSesion()" title="Programar Sesión"></i>
                                <i class="fa-solid fa-user-lock text-danger" style="font-size: 22px;" onclick="confirmarBloqueoPaciente('Ivan Flores')" title="Bloquear Paciente"></i>
                            </td>
                        </tr>
                    </tbody>
                </table>
    ...
    <script>
        function confirmarBloqueoPaciente(nombre) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire(
                        ...
                        'El paciente ' + nombre + ' ha sido bloqueado/a.',
                        'success'
                    )
                }
            });
...
<script>
    function confirmarDarAlta(nombre) {
        Swal.fire({
