    ...
    <body id="page-top">
        ...
        <aside class="text-center bg-gradient-primary-to-secondary py-4">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <h1 class="display-3 font-weight-bold text-white font-alt mb-4">Nuestros Servicios</h1>
                    </div>
                </div>
            </div>
        </aside>
                ...
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-md-4 mb-5 mr-3 ml-3 d-flex justify-content-center align-items-end">
                        ...
                        <div class="text-center img-feature">
                            ...
                            <h3 class="font-alt" style="color: #727FAB;">Taller de Cuerdas Bajas</h3>
                            <p class="text-muted mb-0 description description-left">"En nuestra fundación, nos enfocamos en ofrecer apoyo integral para aquellos que atraviesan momentos difíciles. Nuestro Taller de Cuerdas Bajas está diseñado específicamente para personas que se sienten abrumadas, desmotivadas o atrapadas en un estado de tristeza profunda."</p>
                        </div>
                    </div>
        ...
        <aside class="text-center bg-gradient-primary-to-secondary py-4">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <h1 class="display-3 font-weight-bold text-white font-alt mb-4">Te Ofrecemos...</h1>
                    </div>
                </div>
            </div>
        </aside>
