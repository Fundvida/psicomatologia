...
export default function HomePaciente({user,psicologo_id,paciente_id,sesiones,psicologos,pagos_pendientes,horarios}) {
 ...
 /* console.log("user")
  ...
  const asignarPsicologo = (psicologo_id) => {
