  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo me-5" href="index.html"><img src="<?php echo e(asset('./images/logo gav.png')); ?>" style=""/></a>
        <a class="navbar-brand brand-logo-mini" href="index.html"><img src="<?php echo e(asset('./images/logo gav.png')); ?>" style=""/></a>
      </div>
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            ...
            <form method="POST" class="dropdown-item" action="<?php echo e(route('cerrar_sesion')); ?>">
                <?php echo csrf_field(); ?>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <a class="nav-link" >
              ...
              <span class="menu-title">Registro Psicologos</span>
            </a>
          </li>
          <li class="nav-item">
...
<?php /**PATH C:\laragon\www\sistema_psicologia\resources\views/home.blade.php ENDPATH**/ ?>