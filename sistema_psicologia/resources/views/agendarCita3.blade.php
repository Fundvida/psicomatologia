        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm" id="mainNav">
            ...
            <section class="py-5 d-flex justify-content-center align-items-center" style="min-height: calc(100vh - 100px); margin-top: 100px;" id="agendarCita2">
                <div class="container px-5 text-center shadow-lg p-5 rounded mt-2">
                    ...
                    <h2 class="text-start mb-4 font-alt">Detalles Adicionales de la Consulta</h2>
                    <!-- Descripción "Seleccione el servicio por el que está interesado/a." alineada a la izquierda -->
                    <p class="text-start lead fw-normal text-muted mb-5 ttNorms">Por favor, proporcione cualquier información adicional que pueda ayudarnos a brindarle un mejor servicio.</p>

                    <!-- Cuadro de texto para detalles adicionales -->
                    <div class="row mb-5">
                        <div class="col">
                            <textarea class="form-control custom-textarea" id="detalles" rows="5" placeholder="Ingrese detalles adicionales..."></textarea>
                        </div>
                    </div>
