                ...
                <div class="row gx-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="masthead-device-mockup">
                            <img src="{{ asset('images/landing1.png') }}" alt="landing1" style="height: 500px">
            ...
            <div class="container px-5">
                <div class="row gx-5 justify-content-center">
                    <div class="col-xl-8">
                        ...
                        <img src="{{ asset('images/logof.png') }}" alt="landing2" style="height: 100px">
                    </div>
                </div>
            </div>
        </aside>
                ...
                <div class="row gx-5 align-items-center">
                    ...
                    <div class="col-lg-4 order-lg-0">
                        ...
                        <div class="features-device-mockup">
                            <img src="{{ asset('images/landing2.png') }}" alt="landing2" style="height: 500px">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container px-5">
                <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                    ...
                    <div class="col-sm-8 col-md-6">
                        <div class="px-5 px-sm-0"><img src="{{ asset('images/landing3.png') }}" alt="landing3" style="height: 500px"></div>
                    </div>
                </div>
            </div>
        </section>
