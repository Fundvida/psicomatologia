        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm" id="mainNav">
            ...
            <section class="py-5 d-flex justify-content-center align-items-center" style="min-height: calc(100vh - 100px); margin-top: 100px;" id="agendarCita2">
                <div class="container px-5 text-center shadow-lg p-5 rounded mt-2">
                    ...
                    <p class="text-start lead fw-normal text-muted mb-5 ttNorms">Seleccione el servicio por el que está interesado/a.</p>

                    <!-- Botones de servicios -->
                    <div class="row mb-5">
                        <!-- Botones en la primera fila -->
                        <div class="col-md-6 mb-3">
                            <button type="button" class="btn btn-outline-primary btn-lg btn-servicio rounded-pill w-100 fw-bold">
                        ...
                        <div class="col-md-6 mb-3">
                            <button type="button" class="btn btn-outline-primary btn-lg btn-servicio rounded-pill w-100 fw-bold">
                                <i class="bi bi-grid servicio-icon"></i> Taller de Charlas y Foros
                            </button>
                        </div>
                        <div class="col-md-6 mb-3">
                            <button type="button" class="btn btn-outline-primary btn-lg btn-servicio rounded-pill w-100 fw-bold">
