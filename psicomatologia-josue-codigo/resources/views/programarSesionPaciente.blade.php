    ...
    <main class="main-content ">
        <section class="py-0 d-flex justify-content-center align-items-center" id="">
            <div class="container px-5 text-center shadow-lg p-5 rounded mt-2">
                ...
                <h2 class="display-3 lh-1 mb-5 font-alt">Horario de la Consulta</h2>
                <p class="lead fw-normal text-muted mb-5 ttNorms">Por favor, Seleccione un horario disponible de su profesional designado.</p>
                    ...
                    success: function(response) {
                        ...
                        if(response.message==="sesion pendiente"){
                            Swal.fire({
                                icon: "error",
                                title: "Oops...",
                                text: "No puede programar una reunión hasta que finalize la que ya tiene programada.",
                            });
                        }else{
                            Swal.fire(
                                '<h2 class="text-center mb-4 font-alt">Éxito</h2>',
                                `Sesion programada con exito!`,
                                'success'
                            )
                            setTimeout(function() {
