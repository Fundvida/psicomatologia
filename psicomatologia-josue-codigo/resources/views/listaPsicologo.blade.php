...
<body>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-alt">Registrar Profesional</h5>
                ...
                <div class="modal-body">
                    <form action="{{ route('psicologo.store') }}" method="POST">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" id="btnAddOrEdit" class="btn btn-primary">Registrar Profesional</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <section class="py-1 d-flex justify-content-center align-items-center" id="sesiones">
            ...
            <div class="container px-5">
                <div class="container px-5 text-center shadow-lg p-5 rounded mt-2">
                    <!-- Título -->
                    <h2 class="display-3 lh-1 mb-5 font-alt">Listado de Profesionales</h2>
                    ...
                    <div class="text-end mb-3">
                        <button class="btn btn-outline-primary btn-lg btn-paso1 fw-bold" onclick="limpiar()">
                            <i class="bi bi-person-plus-fill me-2"></i> Agregar Profesional
                        </button>
                    </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" id="filtroNombre" placeholder="Nombre del Profesional">
                        </div>
                        <div class="col-md-3">
                            <input type="text" class="form-control" id="filtroCI" placeholder="CI del Profesional">
                        </div>
                        <div class="col-md-1">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped custom-table">
                                <thead>
                                    <tr>
                                        <th>CI</th>
                                        <th>Nombre Completo Profesional</th>
                                        <th>Estado</th>
                                        <!-- <th>CV</th> -->
                                        <th>Acciones</th>
                                    </tr>
    ...
    <script>
                            ...
                            $('#psicologos-body').append(`
                                <tr>
                                    ...
                                    <td class="action-icons">
                                        <i class="fas fa-edit me-2" style="color: #6C757D; font-size: 22px;" onclick="editar(${psicologo.id})" title="Editar Profesional"></i>
        ...
        function limpiar() {
            ...
            document.getElementById("btnAddOrEdit").textContent = "Registrar Profesional";
        ...
        function editar(psicologoId) {
            document.getElementById("btnAddOrEdit").textContent = "Editar Profesional";
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            Swal.fire({
                title: "Éxito!",
                text: "Profesional actualizado exitosamente!",
                icon: "success"
            });
        });
    </script>
