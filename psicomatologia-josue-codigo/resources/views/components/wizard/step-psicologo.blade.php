<div id="step-psychologist" class="content step" role="tabpanel" aria-labelledby="psychologist-step-trigger">
    ...
    <h2 class="text-start mb-4 font-alt">Seleccione al Profesional</h2>
    ...
    <p class="text-start lead fw-normal text-muted mb-5 ttNorms">Por favor revisa la lista y
        selecciona al Profesional en disponibilidad de su preferencia.</p>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title font-alt" id="staticBackdropLabel">Información del Profesional</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
