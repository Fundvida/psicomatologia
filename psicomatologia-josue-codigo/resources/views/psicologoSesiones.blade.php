        ...
        <section class="py-1 d-flex justify-content-center align-items-center" id="sesiones">
            ...
            <div class="container px-5">
                <div class="container px-5 text-center shadow-lg p-5 rounded mt-2">
                    <!-- Título -->
                    <h2 class="display-3 lh-1 mb-5 font-alt">Lista de Sesiones o Eventos Programados</h2>
                    <p class="lead fw-normal text-muted mb-5 ttNorms" style="line-height: 1.5em;">Consulta tus sesiones o eventos programados. </p>
                    ...
                    <div class="icon-legend">
                        <span><i class="fas fa-edit text-primary"></i> Editar Sesión o Evento</span>
                        <span><i class="fas fa-times-circle text-danger"></i> Cancelar Sesión o Evento</span>
                        <span><i class="fa-solid fa-file-invoice-dollar" style="color: #d86464;"></i> Ver comprobante de pago</span>
                        <span><i class="fas fa-info-circle" style="color: #7c87e4;"></i> Detalle de la Sesión o Evento</span>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <input type="text" class="form-control" id="filtroCI" placeholder="CI/NIT del Paciente">
                    </div>
                    <div class="col-md-1">
