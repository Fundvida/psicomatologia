...
// node_modules/@toast-ui/react-calendar/dist/toastui-react-calendar.mjs
...
var DatePicker = getDefaultExportFromCjs(tuiDatePicker.exports);
...
var templates = {
  ...
  time(model) {
    ...
    if (start) {
      return h$3("span", null, h$3("strong", null, toFormat(start, "HH:mm")), "\xA0", h$3("span", null, stripTags(title)));
    }
...
var optionsProps = ["useFormPopup", "useDetailPopup", "isReadOnly", "week", "month", "gridSelection", "usageStatistics", "eventFilter", "timezone", "template"];
var reactCalendarEventNames = ["onSelectDateTime", "onBeforeCreateEvent", "onBeforeUpdateEvent", "onBeforeDeleteEvent", "onAfterRenderEvent", "onClickDayName", "onClickEvent", "onClickMoreEventsBtn", "onClickTimezonesCollapseBtn"];
var ToastUIReactCalendar = class extends import_react.default.Component {
  constructor() {
    super(...arguments);
    __publicField(this, "containerElementRef", import_react.default.createRef());
  ...
  render() {
    return jsxDevRuntime.exports.jsxDEV("div", {
      className: "container",
...
export {
  ToastUIReactCalendar as default
};
/*
object-assign
(c) Sindre Sorhus
 ...
 */
//# sourceMappingURL=@toast-ui_react-calendar.js.map
