...
var a = function() {
  ...
  return n2.matchesUrl = function(r3) {
    ...
    var r3 = this, n3 = this.parameterSegments;
    return n3.length ? this.template.replace(/{([^}?]+)(\??)}/g, function(e2, i2, u2) {
      var o2;
      if (!u2 && [null, void 0].includes(t2[i2]))
        throw new Error("Ziggy error: '" + i2 + "' parameter is required for route '" + r3.name + "'.");
      if (r3.wheres[i2]) {
        var f2, c2;
        if (!new RegExp("^" + (u2 ? "(" + r3.wheres[i2] + ")?" : r3.wheres[i2]) + "$").test(null != (f2 = t2[i2]) ? f2 : ""))
          throw new Error("Ziggy error: '" + i2 + "' parameter does not match required format '" + r3.wheres[i2] + "' for route '" + r3.name + "'.");
        if (n3[n3.length - 1].name === i2)
          return encodeURIComponent(null != (c2 = t2[i2]) ? c2 : "").replace(/%2F/g, "/");
      }
      return encodeURIComponent(null != (o2 = t2[i2]) ? o2 : "");
...
var s = function(t2) {
  ...
  return c2.toString = function() {
    ...
    var t3 = this.h(), r2 = t3.pathname, n3 = t3.search;
    ...
    return i({}, this.p(r2), this.g(t3, r2));
  }, c2.p = function(t3) {
    var r2 = this;
